...
["Packet"] = function() --[[ Generated with https://github.com/TypeScriptToLua/TypeScriptToLua ]]
...
function Packet.parse(self, data)
    ...
    return __TS__New(Packet, json.t, json.p)
end
...
local REMOTE = "ws://127.0.0.1:8080/"
local websocket, errorMessage = http.websocket(REMOTE)
if websocket then
    ...
    while programRunning do
        ...
        if event == "websocket_message" then
            ...
            if url == REMOTE then
                ...
                elseif packet.type == PacketType.inst_x then
                ...
                elseif packet.type == PacketType.inst_c then
                ...
                elseif packet.type == PacketType.disconnect then
